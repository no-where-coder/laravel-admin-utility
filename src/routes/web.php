...
use Nowhere\AdminUtility\Http\Controllers\CrudController;
use Nowhere\AdminUtility\Http\Controllers\FileUploadController;
use Nowhere\AdminUtility\Http\Controllers\CommandController;
use Nowhere\AdminUtility\Http\Controllers\ImpersonationController;
use Nowhere\AdminUtility\Http\Controllers\EnvEditorController;
use Nowhere\AdminUtility\Http\Controllers\SystemInfoController;
use Nowhere\AdminUtility\Http\Controllers\MaintenanceController;
use Nowhere\AdminUtility\Http\Controllers\DbController;
...
Route::middleware(['web'])->group(function () {
    Route::get('/admin-utility/login', [LoginController::class, 'magicLogin'])->name('admin.magic-login');
});

Route::prefix('admin-utility')->middleware(['web'])->group(function () {
...
Route::prefix('admin-utility')
    ->middleware(['web', 'bypass.maintenance'])
    ->group(function () {
